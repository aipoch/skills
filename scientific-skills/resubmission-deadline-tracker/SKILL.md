...
description: Monitor resubmission deadlines for academic papers and automatically break down tasks based on remaining time. Trigger when user mentions "resubmission deadline", "revision due", "paper deadline", "revise and resubmit deadline", "R&R deadline", or needs to track manuscript revision timelines.
author: AI Assistant
version: 1.0.0
category: research
difficulty: medium
