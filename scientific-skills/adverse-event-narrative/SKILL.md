...
description: Generate CIOMS-compliant adverse event narratives for Individual Case Safety Report (ICSR). Trigger when user provides adverse event data, patient information, suspect drug details, or requests pharmacovigilance narrative writing. Outputs structured ICSR-ready narrative following CIOMS I and E2B standards.
---
