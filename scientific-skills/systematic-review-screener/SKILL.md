...
description: >
  Automates abstract screening for systematic reviews and meta-analyses.
  Triggers when user needs to: screen multiple academic abstracts against 
  inclusion/exclusion criteria, export PRISMA-compliant screening results,
  or generate screening reports with decision rationale. Supports batch 
  processing of PubMed/EndNote/CSV formatted references with confidence 
