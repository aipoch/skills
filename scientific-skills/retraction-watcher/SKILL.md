...
description: Automatically scan document reference lists and check against Retraction Watch database to warn about retracted or questionable citations. Supports PDF, text, and bibliography files. Triggers when user asks to check references, verify citations, or scan for retracted papers.
---
