...
description: One-click synchronization and standardization of reference formats in Zotero/EndNote. Automatically fixes metadata errors from web scraping. Supports batch processing, format standardization, missing field detection and completion.
---
