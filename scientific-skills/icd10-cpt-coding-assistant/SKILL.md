...
description: >
  Automatically recommend ICD-10 diagnosis codes and CPT procedure codes from clinical notes.
  Trigger when: user provides clinical notes, patient encounter summaries, discharge summaries,
  or asks for medical coding assistance. Use for healthcare providers, medical coders, and
  billing professionals who need accurate code recommendations.
---
